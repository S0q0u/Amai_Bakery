...
class CakeList with ChangeNotifier {
  ...
  Cake?
      _selectedCake; // Variabel yang menyimpan satu instance dari kue yang dipilih.
  Cake? get selectedCake =>
      _selectedCake; // Getter yang memberikan akses ke instance kue yang dipilih.
  final Set<Cake> _selectedCakes =
      {}; //Set yang menyimpan banyak instance dari kue yang dipilih.
  Set<Cake> get selectedCakes =>
      _selectedCakes; //Getter yang memberikan akses ke Set kue yang dipilih.
